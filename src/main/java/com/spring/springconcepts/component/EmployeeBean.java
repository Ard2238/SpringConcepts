package com.spring.springconcepts.component;
...
public class EmployeeBean {
    ...
    public EmployeeBean(DepartmentBean deptBean){
        logger.trace("Autowiring by using @Autowired on constructor");
    ...
    public void setDeptBean(DepartmentBean deptBean) {
        logger.trace("Autowiring by using @Autowired on setter-level");
        this.deptBean = deptBean;
    }
